...
import { Star, Users, CheckCircle, Award, ChevronLeft, ChevronRight } from 'lucide-react';
import AOS from 'aos';
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400" data-aos="fade-up">
          Popular Skills
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {skillsData.map((skill, index) => (
            ...
            >
              ...
              />
              <div className="p-4">
                <h3 className="text-xl font-semibold mb-2 text-white">{skill.skillName}</h3>
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 font-bold">${skill.price}</span>
                </div>
                <a
                  href="#details"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center" data-aos="fade-up" data-aos-delay="100">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">1. Browse Skills</h3>
              <p className="text-gray-400">
                Explore our wide range of skills offered by local experts in your area.
              </p>
            </div>
            ...
            <div className="text-center" data-aos="fade-up" data-aos-delay="200">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">2. Book a Session</h3>
              <p className="text-gray-400">
                Select a skill that interests you and book a convenient time slot.
              </p>
            </div>
            ...
            <div className="text-center" data-aos="fade-up" data-aos-delay="300">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">3. Learn & Grow</h3>
              <p className="text-gray-400">
                Attend your session, learn new skills, and become part of our community.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {topRatedSkills.map((skill, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">{skill.providerName}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center" data-aos="fade-up">
              <div className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400 mb-2">500+</div>
            ...
            <div className="text-center" data-aos="fade-up" data-aos-delay="200">
              <div className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-400 to-blue-400 mb-2">95%</div>
              <p className="text-gray-400 text-lg">Satisfaction Rate</p>
            </div>

            <div className="text-center" data-aos="fade-up" data-aos-delay="300">
              <div className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400 mb-2">24/7</div>
